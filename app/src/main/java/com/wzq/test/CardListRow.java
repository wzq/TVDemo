...
public class CardListRow extends ListRow {
    ...
    private Object mCardRow;

    public CardListRow(HeaderItem header, ObjectAdapter adapter, Object cardRow) {
        super(header, adapter);
        setCardRow(cardRow);
    }

    public Object getCardRow() {
        return mCardRow;
    }

    public void setCardRow(Object cardRow) {

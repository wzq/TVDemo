 ...
 * </p>
 * <p>
 * A {@link com.wzq.leanback.app.BrowseFragment} includes an optional “fastlane”
 ...
 * {@link com.wzq.leanback.widget.ObjectAdapter} containing the list of
 * rows and a {@link com.wzq.leanback.widget.PresenterSelector} of row presenters.
 * </p>
 * <p>
 * A {@link com.wzq.leanback.app.DetailsFragment} will typically consist of a large
 ...
 * The {@link com.wzq.leanback.widget.DetailsOverviewRow} and
 * {@link com.wzq.leanback.widget.DetailsOverviewRowPresenter} provide a default template
 * for this row.
 * </p>
 * <p>
 * A {@link com.wzq.leanback.app.PlaybackOverlayFragment} implements standard playback
 * transport controls with a Leanback
 * look and feel.  It is recommended to use an instance of the
 * {@link com.wzq.leanback.app.PlaybackControlGlue} with the
 ...
 * </p>
 * <p>
 * A {@link com.wzq.leanback.app.SearchFragment} allows the developer to accept a query
 * from a user and display the results
 * using the familiar list rows.
 * </p>
 * <p>
 * A {@link com.wzq.leanback.app.GuidedStepFragment} is used to guide the user through a
